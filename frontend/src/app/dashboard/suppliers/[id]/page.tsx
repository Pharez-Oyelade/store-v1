  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <PageHeader
        ...
        action={
          <a
            href={buildWhatsAppLink(supplier.data.phone)}
            target="_blank"
            rel="noreferrer"
          ...
          <div className="rounded-lg border border-gray-100 bg-white p-5 shadow-card">
            ...
            {showNewPurchase && (
              <form
                ...
                className="mb-6 grid gap-4 rounded-md bg-gray-50 p-4 border border-gray-100"
              >
                <Input
                ...
                <Button type="submit" isLoading={updateSupplier.isPending}>
                  Save Purchase
                </Button>
              </form>
            )}
        ...
        <aside className="space-y-4 rounded-lg border border-gray-100 bg-white p-5 shadow-card h-fit">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              >
                {Object.values(SupplierCategory).map((v) => (
            ...
            <div className="space-y-1.5">
              ...
              >
                {Object.values(SupplierStatus).map((v) => (
                  <option key={v} value={v}>
                    {v}
                  </option>
                ))}
