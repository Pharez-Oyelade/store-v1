  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mb-6 rounded-lg border border-brand-200 bg-brand-50 p-5 dark:border-brand-900/50 dark:bg-brand-900/10 flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-brand-900 dark:text-brand-100 mb-1">WhatsApp Templates</h2>
          <p className="text-sm text-brand-700 dark:text-brand-300">Customize your automated social messaging templates.</p>
        </div>
        <a href="/dashboard/settings/templates" className="inline-flex h-9 items-center justify-center rounded-md bg-brand-600 px-4 py-2 text-sm font-medium text-white shadow transition-colors hover:bg-brand-700">
          Edit Templates
        </a>
      </div>
